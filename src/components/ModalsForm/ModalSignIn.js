...
import {Form,InputWhithIcon,Centrar,ButtonSubmit,LineCenter,TextGray,Button } from './styles'
    ...
    return (
        <div>
            ...
            <Background onClick={closeModal} ref={modalRef} >
                ...
                <Form ref={FormModal} onSubmit={ handleSubmit(data => handleSubmitForm(data) ) }>
                    ...
                    <div class="form-group" style={{margin:"0"}}>
                        ...
                        <InputWhithIcon>
                            ...
                            {/* icon */}
                            <i style={{top:"-8px"}} ><IoMailOutline /> </i>
                    ...
                    <div class="form-group">
                        ...
                        <InputWhithIcon>
                            <input 
                                ...
                                style={{fontSize:"1rem"}}
                            />
                            <i style={{top:"4px"}} > <IoLockClosedOutline /> </i>
                ...
                <Centrar>
                    {/* button google  */}
                    <GoogleButton contentSign={'Sign In'} />
                </Centrar>
                <Centrar >
                    <TextGray>If you are new in Ingenio Languages Create an account </TextGray>
                </Centrar>
                <Centrar>
